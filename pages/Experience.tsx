  ...
  return (
    <div className="pt-32 min-h-screen bg-offwhite">
       <div className="container mx-auto px-6 mb-20 text-center">
          <h1 className="text-5xl md:text-7xl font-oswald font-bold uppercase text-primary mb-6">Professional Journey</h1>
          <p className="font-mono text-muted max-w-2xl mx-auto">My career path and the roles that have shaped my skills.</p>
       </div>
          ...
          <div className="space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
             {EXPERIENCES.map((exp, index) => (
                <div key={exp.id} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                   ...
                   {/* Card */}
                   <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white p-6 rounded shadow-sm border border-slate-200 hover:shadow-lg transition-shadow duration-300">
